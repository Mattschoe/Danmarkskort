...
public enum ColorSheet {
    ...
    public Color paletteDefault() {
        return switch(this) {
            ...
            case POLY_INSTITUTIONAL -> Color.rgb(50, 75, 75);
            //endregion
            ...
            case POLY_PADDY          -> Color.TRANSPARENT;
            case POLY_ANIMAL_KEEPING -> Color.TRANSPARENT;
            case POLY_FLOWER_BED     -> Color.rgb(205, 235, 176);
            case POLY_FOREST         -> Color.rgb(172, 210, 156);
            case POLY_LOGGING        -> Color.TRANSPARENT;
            ...
            case POLY_DEPOT             -> Color.TRANSPARENT;
            ...
            case POLY_PORT              -> Color.TRANSPARENT;
            ...
            case POLY_GREENERY          -> Color.TRANSPARENT;
            case POLY_WINTER_SPORTS     -> Color.TRANSPARENT;
            //endregion
            ...
            case POLY_TREE_STUMP -> Color.TRANSPARENT;
            case POLY_TUNDRA     -> Color.TRANSPARENT;
            ...
            case POLY_BLOWHOLE   -> Color.TRANSPARENT;
            case POLY_CAPE       -> Color.TRANSPARENT;
            case POLY_CREVASSE   -> Color.TRANSPARENT;
            case POLY_GEYSER     -> Color.TRANSPARENT;
            case POLY_GLACIER    -> Color.rgb(221, 236, 236);
            case POLY_HOT_SPRING -> Color.TRANSPARENT;
            case POLY_ISTHMUS    -> Color.TRANSPARENT;
            ...
            case POLY_EARTH_BANK    -> Color.TRANSPARENT;
            case POLY_FUMAROLE      -> Color.TRANSPARENT;
            case POLY_GULLY         -> Color.TRANSPARENT;
            ...
            //region leisure
            case POLY_ADULT_GAMING_CENTRE -> Color.TRANSPARENT;
            case POLY_AMUSEMENT_ARCADE    -> Color.rgb(14, 133, 23);
            case POLY_BANDSTAND           -> Color.TRANSPARENT;
            case POLY_BATHING_PLACE       -> Color.TRANSPARENT;
            ...
            case POLY_HACKERSPACE         -> Color.TRANSPARENT;
            ...
            case POLY_FLOWERBED  -> Color.TRANSPARENT;
            case POLY_ROUTE      -> Color.TRANSPARENT;
            case POLY_SPORT      -> Color.TRANSPARENT;
            case POLY_YES        -> Color.TRANSPARENT;
            case POLY_PAVED      -> Color.TRANSPARENT;
